...
- (WKWebView *)webView
{
  if (_webView == nil) {
    ...
    [controller addUserScript:[self userScriptSampleLocationBGInjectionForAppEvent]];
...
- (WKUserScript *)userScriptSampleLocationBGInjectionForAppEvent
{
  if (_pageToken == nil) {
...
- (WKUserScript *)userScriptSampleLocationBGJSEvaluationFromString:(NSString *)string
{
...
- (void)webView:(WKWebView *)webView decidePolicyForNavigationAction:(nonnull WKNavigationAction *)navigationAction decisionHandler:(nonnull void (^)(WKNavigationActionPolicy))decisionHandler
{
  ...
  if ([allowedURLSchemes containsObject:navigationAction.request.URL.scheme]) {
    if ([[UIApplication sharedApplication] canOpenURL:navigationAction.request.URL]) {
      // Event to return url to SampleLocationBG in order to handle OAuth and more
