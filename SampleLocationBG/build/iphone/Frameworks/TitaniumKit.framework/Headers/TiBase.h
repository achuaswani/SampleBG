...
// in simulator we redefine to format for SampleLocationBG Developer console
...
#define DEFINE_EXCEPTIONS                                                                                      \
  ...
  {                                                                                                            \
    NSString *exceptionName = [@"org.samplelocationbg." stringByAppendingString:NSStringFromClass([self class])];  \
    TiExceptionThrowWithNameAndReason(exceptionName, reason, subreason, location);                             \
  }                                                                                                            \
                                                                                                               \
  +(void)throwException : (NSString *)reason subreason : (NSString *)subreason location : (NSString *)location \
  {                                                                                                            \
    NSString *exceptionName = @"org.samplelocationbg";                                                             \
    TiExceptionThrowWithNameAndReason(exceptionName, reason, subreason, location);                             \
  }
...
enum {
  UISampleLocationBGNativeItemNone = -1,
  UISampleLocationBGNativeItemSpinner = -2,
  UISampleLocationBGNativeItemProgressBar = -3,

  UISampleLocationBGNativeItemSlider = -4,
  UISampleLocationBGNativeItemSwitch = -5,
  UISampleLocationBGNativeItemMultiButton = -6,
  UISampleLocationBGNativeItemSegmented = -7,

  UISampleLocationBGNativeItemTextView = -8,
  UISampleLocationBGNativeItemTextField = -9,
  UISampleLocationBGNativeItemSearchBar = -10,

  UISampleLocationBGNativeItemPicker = -11,
  UISampleLocationBGNativeItemDatePicker = -12,

  UISampleLocationBGNativeItemInfoLight = -13,
  UISampleLocationBGNativeItemInfoDark = -14,

  UISampleLocationBGNativeItemDisclosure = -15,

  UISampleLocationBGNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all SampleLocationBG instances of
