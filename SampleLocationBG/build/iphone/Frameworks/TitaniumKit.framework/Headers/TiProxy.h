...
// Rare exceptions to indicate a bug in the _samplelocationbg code (Eg, function that a subclass should have implemented)
...
/**
 The base class for SampleLocationBG proxies.
 */
