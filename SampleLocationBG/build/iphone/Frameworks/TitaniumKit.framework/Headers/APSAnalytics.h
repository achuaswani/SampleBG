 ...
 * to send analytic data that can be viewed on the SampleLocationBG Dashboard.
 *
 * For information on getting started with SampleLocationBG Platform Services,
 * see [SampleLocationBG Platform Services for iOS](http://bit.ly/1kqteQS).
 */
